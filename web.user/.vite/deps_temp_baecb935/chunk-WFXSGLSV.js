...
var Meta = (props) => {
  const {
    ...
    title,
    description
  } = props, others = __rest4(props, ["prefixCls", "className", "avatar", "title", "description"]);
  const {
    getPrefixCls
  } = React31.useContext(ConfigContext);
  const prefixCls = getPrefixCls("card", customizePrefixCls);
  const classString = (0, import_classnames2.default)(`${prefixCls}-meta`, className);
  const avatarDom = avatar ? React31.createElement("div", {
    className: `${prefixCls}-meta-avatar`
  }, avatar) : null;
  const titleDom = title ? React31.createElement("div", {
    className: `${prefixCls}-meta-title`
  }, title) : null;
  const descriptionDom = description ? React31.createElement("div", {
    className: `${prefixCls}-meta-description`
  }, description) : null;
  const MetaDetail = titleDom || descriptionDom ? React31.createElement("div", {
    className: `${prefixCls}-meta-detail`
  }, titleDom, descriptionDom) : null;
  return React31.createElement("div", Object.assign({}, others, {
...
//# sourceMappingURL=chunk-WFXSGLSV.js.map
